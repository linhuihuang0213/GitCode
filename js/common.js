...
(function(){
    var doc = $(document), slide = $('.js-slide-left');
    $(window).scroll(function(){
        if ((doc.height() > slide.height() + 200) && doc.scrollTop() >= 175) {slide.addClass('wp-left-fixed');} else {slide.removeClass('wp-left-fixed');}
        if ($(this).height() < slide.height() && (doc.scrollTop() >= doc.height() - $(this).height() - 80)) {slide.addClass('wp-left-fixed-bottom');} else {slide.removeClass('wp-left-fixed-bottom');}
    });
})();
/* 发布内容 增加、删除 */
(function(){
